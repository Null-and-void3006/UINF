...
public class CalculateCountAction extends AbstractAction{
	String avg;
	JTextArea group;
	ResultSet result;
	JTable table;
	
	public CalculateCountAction(String s, JTextArea group) {
		putValue(NAME, "Calculate Count for "+s);
		this.avg = s;
		this.group = group;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			ExceptionFrame frame = new ExceptionFrame(3,e1);
			//e.printStackTrace();
		}
	}
}
